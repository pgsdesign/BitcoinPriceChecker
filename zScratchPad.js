//I copied all the code from the Google slide here to then put into the index.js file in the project.
...
//Fetch the Bitcoin price every 3 seconds
...
//Create a function to show and hide the price
...
//Make the refresh button functional
